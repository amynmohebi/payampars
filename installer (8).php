...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230601_payampars_d8bbb5b5aff64a0c3913_20230604151407_archive.zip';
        const ARCHIVE_SIZE       = '98055944';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'd8bbb5b-04151407';
        const SECONDARY_PACKAGE_HASH = '5eb4b19-04151407';
        const VERSION            = '1.5.4';
